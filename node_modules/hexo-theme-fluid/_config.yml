...
color:
  ...
  # 文章超链接字体色
  # Color of post link
  post_link_color: "#007AFF"
  post_link_color_dark: "#0A84FF"
...
font:
  font_size: 16px
  font_family: '-apple-system, BlinkMacSystemFont, "PingFang SC", "Helvetica Neue", sans-serif'
...
web_analytics:
 ...
 #  See: https://tongji.baidu.com/sc-web/10000033910/home/site/getjs?siteId=e149a5188a8e7c2c1d7b959319026edf
  baidu: 22a43926b9780fefa572f2daadb2889f
...
footer:
  ...
  content: '
    <a href="https://www.uczyw.com" target="_blank" rel="nofollow noopener"><span>Uczyw.Com</span></a>
    <i class="iconfont icon-love"></i>
    <a href="https://www.iosgift.com" target="_blank" rel="nofollow noopener"><span>iOSGift</span></a>
  '
...
giscus:
  repo: iuczy8/xinxuan-ios
  repo-id: R_kgDORo-6bg
  category: Announcements
  category-id: DIC_kwDORo-6bs4C4lPW
  theme-light: light
  theme-dark: dark
  mapping: pathname
  reactions-enabled: 1
...
about:
  ...
  banner_img_height: 60
  banner_mask_alpha: 0.3
  avatar: "https://i.imgs.ovh/2026/03/17/Oq47pF.png"
  name: "心选"
  intro: "An elegant theme for Hexo"
  # 更多图标可从 https://hexo.fluid-dev.com/docs/icon/ 查找，`class` 代表图标的 css class，添加 `qrcode` 后，图标不再是链接而是悬浮二维码
  # More icons can be found from https://hexo.fluid-dev.com/docs/en/icon/  `class` is the css class of the icon. If adding `qrcode`, the icon is no longer a link, but a hovering QR code
  icons:
    - { class: "iconfont icon-instagram-fill", link: "https://www.iosgift.com", tip: "iOSGift" }
    - { class: "iconfont icon-apple-fill", link: "https://www.uczyw.com", tip: "优创资源网" }
    - { class: "iconfont icon-wechat-fill", qrcode: "/img/favicon.jpg" }
...
links:
  ...
  items:
    - {
      title: "iOSGift Blog",
      intro: "主题博客",
      link: "https://www.iOSGift.com/",
      avatar: "/img/favicon.png"
    }
    - {
      title: "优创资源网",
      intro: "专注于分享 iOS 安卓 电脑破解游戏软件",
      link: "https://www.Uczyw.cn/",
      avatar: "https://i.imgs.ovh/2026/03/17/Oq2CFY.png"
    }
    - {
      title: "流量卡",
      intro: "免费领取大流量手机卡",
      link: "https://1.simhaoka.com/phone/index?id=EE0A9868BE46F28CD800FDF1BD16E019",
      avatar: "https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/34/a0/2b/34a02b6f-ba55-c338-2572-d527f6ae0fe2/AppIcon-0-0-1x_U007emarketing-0-8-0-0-sRGB-85-220.png/180x180bb.png"
    }
  # 当成员头像加载失败时，替换为指定图片
